...
```{r}
fit.lm2 <- lm(Real.World.CO2 ~ Country + year2015 + production + Weight + Footprint + Horsepower + Fuel.Delivery.GDI + Engine.Displacement, data = result)
summary(fit.lm2)
```
...
```{r}
fit.lm2_reduced <- lm(Real.World.CO2 ~ production, data = result)
